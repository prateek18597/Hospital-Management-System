...
public class AddInventory extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            rs=stat.executeQuery("Select count(*) from Inventory");
            int count=0;
            if(rs.next())
            {
            ...
            count++;
            int status=stat.executeUpdate("insert into Inventory values('I"+count+"','"+driverName+"','"+dl+"')");
            JOptionPane.showMessageDialog(rootPane, "Successfully Added Item in Database. Item Id is I"+count+".");
//            jButton3.doClick();
            jTextField1.setText("I"+count);
        }
        catch(Exception e)
        {
